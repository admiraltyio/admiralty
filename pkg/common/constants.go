...
var (
	...
	AnnotationKeyProxyPodClusterName = AnnotationKeyPrefixProxyPod + "clustername"
	AnnotationKeyProxyPodNamespace   = AnnotationKeyPrefixProxyPod + "namespace"
	AnnotationKeyProxyPodName        = AnnotationKeyPrefixProxyPod + "name"
)
