	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MulticlusterV1alpha1().Sources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MulticlusterV1alpha1().Sources(namespace).Watch(context.TODO(), options)
			},
		},
		&multiclusterv1alpha1.Source{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&multiclusterv1alpha1.Source{}, f.defaultInformer)
}
